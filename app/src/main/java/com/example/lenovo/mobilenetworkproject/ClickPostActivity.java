    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClickPostRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    description = dataSnapshot.child("descrption").getValue().toString();
                  ...
                  //  ImageLoader loader = ImageLoader.getInstance();
                    //loader.displayImage(image, PostImage);
    ...
    private void EditCurrentPost(String description)
    {
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ClickPostRef.child("descrption").setValue(inputField.getText().toString());
                Toast.makeText(ClickPostActivity.this, "Your post updated succesfully", Toast.LENGTH_SHORT).show();
            }
        });
